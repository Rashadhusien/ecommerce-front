...
function Header() {
  ...
  return (
    !isLoggedIn && (
      <header className=" bg-white dark:bg-gray-900 shadow-2xl rounded-b-sm">
            ...
            {!user ? (
              <div className="flex items-center gap-4">
                <div className="sm:flex sm:gap-4">
                  <a
                    className="rounded-md bg-blue-600 px-5 py-2.5 text-sm font-medium text-white shadow dark:hover:bg-blue-800"
                    href="/sign-in"
                  >
                    Login
                  </a>
              ...
              <div className="flex items-center gap-5">
                <h2 className="flex items-center gap-2 cursor-pointer sm:relative">
